...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor', ["jquery","simple-module","simple-hotkeys","simple-uploader","public/assets/plugins/simditor/simditor-2.3.28/scripts/dompurify"], function ($, SimpleModule, simpleHotkeys, simpleUploader, DOMPurify) {
    ...
    // like Node.
    module.exports = factory(require("jquery"),require("simple-module"),require("simple-hotkeys"),require("simple-uploader"),require("public/assets/plugins/simditor/simditor-2.3.28/scripts/dompurify"));
  } else {
      ...
      return function(e, file, xhr) {
        ...
        if (xhr.responseText) {
          try {
            ...
            window.showMessage(msg || '上传失败，重新上传')
        }
        $img = file.img;
        if (!($img.hasClass('uploading') && $img.parent().length > 0)) {
          return;
